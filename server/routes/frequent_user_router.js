...
router.get('/find_all_frequent_from_user_past/:userId', middleware.findUserForCalendar, middleware.findFrequentForStats, middleware.sortEventsForCalendar, frequentUserController.sendEventsForCalendar);
